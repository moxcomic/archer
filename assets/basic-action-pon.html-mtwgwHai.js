import{_ as a,c as e,a as s,o as i}from"./app-BMLQaST_.js";const l={};function o(c,n){return i(),e("div",null,[...n[0]||(n[0]=[s(`<h1 id="calling-the-interface" tabindex="-1"><a class="header-anchor" href="#calling-the-interface"><span>Calling the Interface</span></a></h1><ul><li>Use the <code>Pon</code> method from the <a href="/archer/en/auto/majsoul/actions/basic-action-majsoul">MajsoulActions</a> package to perform a Pon (meld).</li></ul><h1 id="example-code" tabindex="-1"><a class="header-anchor" href="#example-code"><span>Example Code</span></a></h1><div class="language-golang line-numbers-mode" data-highlighter="prismjs" data-ext="golang"><pre><code class="language-golang"><span class="line">package main</span>
