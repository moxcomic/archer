import{_ as a,c as n,a as s,o as i}from"./app-BXqkdwf9.js";const l={};function t(c,e){return i(),n("div",null,[...e[0]||(e[0]=[s(`<h1 id="review" tabindex="-1"><a class="header-anchor" href="#review"><span>Review</span></a></h1><p>In the previous section, we simply called the <a href="/archer/en/auto/majsoul/actions/basic-action-majsoul">actions</a> interface to perform a discard operation. However, we know that in the game of <code>Majsoul</code>, after declaring Riichi, the server will automatically discard the last tile for the player. Therefore, we need to modify the code from the previous section to cancel this action when the player has already declared Riichi.</p><h1 id="how-to-determine-the-state" tabindex="-1"><a class="header-anchor" href="#how-to-determine-the-state"><span>How to Determine the State</span></a></h1><ul><li>The <a href="/archer/en/auto/majsoul/gamestate/basic-gamestate">gamestate</a> library provides some game states that can help you determine the current status of the game.</li></ul><h1 id="example-code" tabindex="-1"><a class="header-anchor" href="#example-code"><span>Example Code</span></a></h1><div class="language-golang line-numbers-mode" data-highlighter="prismjs" data-ext="golang"><pre><code class="language-golang"><span class="line">package main</span>
